...
public class FoursRollProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        return Stream.of(
            Arguments.of(new Game(Roll.of(new int[]{4,4,4,5,5}), Score.of(12))),
            Arguments.of(new Game(Roll.of(new int[]{4,4,5,5,5}), Score.of(8))),
            Arguments.of(new Game(Roll.of(new int[]{4,5,5,5,5}), Score.of(4)))
        );
    }
}
