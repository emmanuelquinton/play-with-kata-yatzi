...
public class FivesRollProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        return Stream.of(
            Arguments.of(new Game(DiceRoll.of(new int[]{4,4,4,5,5}), Score.of(10))),
            Arguments.of(new Game(DiceRoll.of(new int[]{4,4,5,5,5}), Score.of( 15))),
            Arguments.of(new Game(DiceRoll.of(new int[]{4,5,5,5,5}), Score.of( 20)))
        );
    }
}
